...
printint(int fd, int xx, int base, int sgn)
{
 ...
 396:	49e50513          	addi	a0,a0,1182 # 830 <digits>
 39a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 456:	386c8c93          	addi	s9,s9,902 # 7d8 <malloc+0xf8>
 ...
 464:	3d0b8b93          	addi	s7,s7,976 # 830 <digits>
 ...
 58a:	24a98993          	addi	s3,s3,586 # 7d0 <malloc+0xf0>
        while(*s != 0){
 58e:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 66c:	1e07b783          	ld	a5,480(a5) # 848 <freep>
 ...
 694:	00e6ea63          	bltu	a3,a4,6a8 <free+0x4a>
{
 ...
 6d6:	16f73b23          	sd	a5,374(a4) # 848 <freep>
}
 6da:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 708:	14453503          	ld	a0,324(a0) # 848 <freep>
 ...
 730:	11c90913          	addi	s2,s2,284 # 848 <freep>
  if(p == (char*)-1)
 734:	5afd                	li	s5,-1
 736:	a895                	j	7aa <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 738:	00000797          	auipc	a5,0x0
 73c:	11878793          	addi	a5,a5,280 # 850 <base>
 740:	00000717          	auipc	a4,0x0
 744:	10f73423          	sd	a5,264(a4) # 848 <freep>
 748:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 76c:	0ea73023          	sd	a0,224(a4) # 848 <freep>
      return (void*)(p + 1);
